class PlayersController < ApplicationController
    ...
    def index
        ...
        puts("* * * Index endpoint hit")
        render json: Player.all
    end

    def create
        #byebug
        puts("* * * Create endpoint hit")
    ...
    def update
        # byebug
        puts("* * * Update endpoint hit")
        player = Player.find(params["id"])
        player.update(id: params["id"], name: params["name"], lives: params["lives"], score: params["score"])
        render json:player
    end
